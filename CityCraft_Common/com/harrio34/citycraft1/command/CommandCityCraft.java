...
import com.harrio34.citycraft1.lib.Commands;
...
public class CommandCityCraft extends CommandBase
{
	@Override
    public String getCommandName() {

        return Commands.COMMAND_CityCraft1;
    }
    ...
    public void processCommand(ICommandSender commandSender, String[] args) {
        ...
        if (args.length > 0) {
            ...
            if (commandName.equalsIgnoreCase(Commands.COMMAND_OVERLAY)) {
                ...
                throw new WrongUsageException(Commands.COMMAND_CityCraft1_USAGE, new Object[0]);
        }
        else
            throw new WrongUsageException(Commands.COMMAND_CityCraft1_USAGE, new Object[0]);
    }
